...
def main():
    sr_ratio = 10
    X_ori, Y_seq, H_kernel= lr_generation(sr_ratio, "./ori.jpg", rotate_angle_range=20, shift_pixel_range=50, 
                                          noise_sigma=5, use_grayscale=True, blur_kernel_sigma=10, blur_kernel_size=15, 
                                          serie_len=10)
    mv_seq = mv_est(Y_seq)
